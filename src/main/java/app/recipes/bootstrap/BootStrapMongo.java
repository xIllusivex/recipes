...
@Component
@Profile("mongo")
public class BootStrapMongo implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        ...
        unitOfMeasureRepository.findAll().forEach(unitOfMeasure -> unitOfMeasures.add(unitOfMeasure));

        Set<Recipe> recipes = new HashSet<>();
        recipeRepository.findAll().forEach(recipe -> recipes.add(recipe));

        log.debug("Loading mongo Bootstrap Data");
